...
Function 5  —  3 new max(es) across 9 rounds:
...
Function 6  —  1 new max(es) across 9 rounds:
   R2   Y=-0.29023     gain=+0.424   (0.4243, 0.2976, 0.5111, 0.7324, 0.1505)

Function 7  —  3 new max(es) across 9 rounds:
...
Function 8  —  3 new max(es) across 9 rounds:
