...
```
Function 1 — 0 new maxima across 13 rounds
  (no round beat the initial-data best)

Function 2 — 3 new maxima across 13 rounds
  R4   Y=0.62052   gain=+0.00931   (0.6994, 0.9696)
  R5   Y=0.67521   gain=+0.05469   (0.7030, 0.1741)
  R9   Y=0.72173   gain=+0.04652   (0.6863, 0.8694)

Function 3 — 2 new maxima across 13 rounds
  R1   Y=-0.02298   gain=+0.01185   (0.4000, 0.4000, 0.5000)
  R11  Y=-0.01738   gain=+0.00560   (0.6767, 0.6985, 0.3814)

Function 4 — 5 new maxima across 13 rounds
  R1   Y=-0.38486   gain=+3.641    (0.4444, 0.4444, 0.3333, 0.4444)
  R2   Y=-0.03657   gain=+0.3483   (0.3716, 0.4437, 0.3910, 0.4416)
...
Function 5 — 5 new maxima across 13 rounds
...
Function 8 — 7 new maxima across 13 rounds
  R1   Y=9.7833     gain=+0.1848   (0.0000, 0.0000, 0.0000, 0.0000, 1.0000, 0.5000, 0.0000, 0.5000)
  R6   Y=9.8194     gain=+0.0361   (0.0436, 0.1733, 0.1067, 0.2017, 0.3415, 0.3491, 0.0560, 0.5739)
  R8   Y=9.8345     gain=+0.0151   (0.0223, 0.1696, 0.1212, 0.2093, 0.3362, 0.3796, 0.0837, 0.5573)
  R10  Y=9.8390     gain=+0.0044   (0.0463, 0.1498, 0.0906, 0.1846, 0.3110, 0.3789, 0.1129, 0.5878)
  R11  Y=9.8653     gain=+0.0263   (0.0654, 0.1249, 0.0987, 0.1946, 0.3404, 0.3912, 0.1324, 0.5571)
  R12  Y=9.8859     gain=+0.0207   (0.0883, 0.1294, 0.1127, 0.2214, 0.3664, 0.3991, 0.1603, 0.5828)
  R13  Y=9.8908     gain=+0.0049   (0.0546, 0.0833, 0.1643, 0.2087, 0.4228, 0.3536, 0.2210, 0.6409)
```

Gains in original output units. Function 1 is the only function where no round exceeded the initial-data best.
...
The documentation structure provides high level details of the approach followed. More detail is available in the [round-by-round logs](https://github.com/marktjones1/Imperial_College_Capstone/tree/main/results).
